...
browser = "~/.config/hypr/hyprland/scripts/launch_first_available.sh 'google-chrome-stable' 'zen-browser' 'firefox' 'brave' 'brave-origin' 'chromium' 'microsoft-edge-stable' 'opera' 'librewolf'"
